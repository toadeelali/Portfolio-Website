...
describe('Storage Service', () => {
  ...
  describe('getItem', () => {
    ...
    it('should return value', () => {
      ...
      expect(window.localStorage.getItem).toHaveBeenCalledWith('ADEEL-ALI:GISTS')
    })
  ...
  describe('setItem', () => {
    ...
    it('should return same value passed', () => {
      Object.defineProperty(window, 'localStorage', {
        value: {
          setItem: vi.fn(() => JSON.stringify({foo: 'bar'}))
        },
        writable: true
      })
      ...
      expect(window.localStorage.setItem).toHaveBeenCalledWith('ADEEL-ALI:THEME', value)
    })
